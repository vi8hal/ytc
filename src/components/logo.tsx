...
const XerusLogo = ({ className }: { className?: string }) => (
  ...
  >
    ...
    <g transform="translate(-5, 5) scale(1.1)">
        {/* Tail */}
        <path className="xerus-tail" fill="#C67A48" stroke="#8C542E" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" d="M48.2,75.5 C38,88,20,95,25,60 C30,30,45,35,48.2,27.5 C55,45,55,60,48.2,75.5 Z" />
